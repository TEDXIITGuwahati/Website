...
urlpatterns = [
 ...
 path('/about_us.html/speakers.html', views.nominate_others),
    ...
    path('/about_us.html/Pramiti', views.memberDesc1, name='member_description1'),
    ...
    path('/Pramiti', views.memberDesc1, name='member_description1'),
    path('/kavin', views.memberDesc2, name='member_description2'),
    path('/Abhiram', views.memberDesc3, name='member_description3'),
    path('/Shashank', views.memberDesc4, name='member_description4'),
    path('/Sreelakshmi', views.memberDesc5, name='member_description5'),
    path('/Nandini', views.memberDesc6, name='member_description6'),
    path('/Abhinav', views.memberDesc7, name='member_description7'),
    ...
    path('/Anushka', views.memberDesc11, name='member_description11'),
    path('/vamsi', views.memberDesc12, name='member_description12'),
